...
<div class="container-fluid py-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-5 mb-lg-0" src="{{asset('template/assets/img/about-1.jpg')}}" alt="">
                </div>
                <div class="col-lg-7">
                    ...
                    <div class="row pt-2 pb-4">
                        <div class="col-6 col-md-4">
                            <img class="img-fluid rounded" src="asset('template/assets/img/about-2.jpg')" alt="">
                        </div>
