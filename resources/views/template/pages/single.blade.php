...
@section('title', 'KidKinder - Blog Details')
@section('content')
<!-- Header Start -->
    ...
    <div class="container py-5">
        <div class="row pt-5">
            <div class="col-lg-8">
                ...
                <div class="mb-5">
                    <img class="img-fluid rounded w-100 mb-4" src="{{asset('template/assets/img/detail.jpg')}}" alt="Image">
                    ...
                    <img class="img-fluid rounded w-50 float-left mr-4 mb-3" src="{{asset('template/assets/img/blog-1.jpg')}}" alt="Image">
                    ...
                    <img class="img-fluid rounded w-50 float-right ml-4 mb-3" src="{{asset('template/assets/img/blog-2.jpg')}}" alt="Image">
                ...
                <div class="mb-5 mx-n3">
                    ...
                    <div class="owl-carousel post-carousel position-relative">
                        <div class="d-flex align-items-center bg-light shadow-sm rounded overflow-hidden mx-3">
                            <img class="img-fluid" src="{{asset('template/assets/img/post-1.jpg')}}" style="width: 80px; height: 80px;">
                            <div class="pl-3">
                        ...
                        <div class="d-flex align-items-center bg-light shadow-sm rounded overflow-hidden mx-3">
                            <img class="img-fluid" src="{{asset('template/assets/img/post-2.jpg')}}" style="width: 80px; height: 80px;">
                            <div class="pl-3">
                                <h5 class="">Diam amet eos at no eos</h5>
                                <div class="d-flex">
                                    <small class="mr-3"><i class="fa fa-user text-primary"></i> Admin</small>
                        ...
                        <div class="d-flex align-items-center bg-light shadow-sm rounded overflow-hidden mx-3">
                            <img class="img-fluid" src="{{asset('template/assets/img/post-3.jpg')}}" style="width: 80px; height: 80px;">
                            <div class="pl-3">
                                <h5 class="">Diam amet eos at no eos</h5>
                                <div class="d-flex">
                                    <small class="mr-3"><i class="fa fa-user text-primary"></i> Admin</small>
                ...
                <div class="mb-5">
                    ...
                    <div class="media mb-4">
                        <img src="{{asset('template/assets/img/user.jpg')}}" alt="Image" class="img-fluid rounded-circle mr-3 mt-1" style="width: 45px;">
            ...
            <div class="col-lg-4 mt-5 mt-lg-0">
                ...
                <div class="d-flex flex-column text-center bg-primary rounded mb-5 py-5 px-4">
                    <img src="{{asset('template/assets/img/user.jpg')}}" class="img-fluid rounded-circle mx-auto mb-3" style="width: 100px;">
                ...
                <!-- Single Image -->
                <div class="mb-5">
                    <img src="{{asset('template/assets/img/blog-1.jpg')}}" alt="" class="img-fluid rounded">
                </div>
                ...
                <!-- Single Image -->
                <div class="mb-5">
                    <img src="{{asset('template/assets/img/blog-2.jpg')}}" alt="" class="img-fluid rounded">
                </div>
                ...
                <!-- Single Image -->
                <div class="mb-5">
                    <img src="{{asset('template/assets/img/blog-3.jpg')}}" alt="" class="img-fluid rounded">
                </div>
